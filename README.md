...
![Gallery Dashboard Functional](images/sql_command_lvl2.png)
...
<!-- 🖼️ FIGURE 3: SQLMAP CREDENTIAL EXFILTRATION -->
![SQLMap Dump Results](images/foothold_lvl2.png)
...
<!-- 🖼️ FIGURE 4: INTERACTIVE SSH ACCESS -->
![SSH Access Foothold](images/sql_command2_lvl2.png)
*Figure 4: Authenticated user foothold terminal active over standard SSH.*
...
<!-- 🖼️ FIGURE 5: ADMINISTRATIVE DOMINANCE -->
![Root Privilege Escalation and Loot](images/root_escalation_lvl2.png)
